# QuickShulker 4.0.0 for Minecraft 26.1
...
- This artifact is for Minecraft 26.1 and requires Java 25, Fabric Loader, and Fabric API.
- Install matching QuickShulker 4.x builds on the client and server to use the direct shulker protocol.
- Original Quick Shulker `3.0.0-26.1` clients can connect to this v4 server and retain their original packet and bundle-menu behavior.
